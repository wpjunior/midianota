...
<!-- cabeçalho da pesquisa-----> 
			...
			<table width="99%" border="0" cellspacing="2" cellpadding="2">
			  ...
			  <tr>
				...
				?>
				<input type="button" class="botao" value="Comunicar Partes" onclick="window.open('inc/utilitarios/ouvidoria/reclamacoes_email.php?CODIGO=<?php echo $crypto; ?>');"></a>
				</td>
				<td>&nbsp;</td>
			  </tr>
			  <tr>
