    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="120" align="left" valign="top" bgcolor="#CCCCCC" style="padding:5px;"><font class="boxTitulo"> Modelo de RPS</font>
          <br />
          <br />
          Se voc&ecirc;, ou sua empresa, n&atilde;o possui sistema que emita documento que  possa ser utilizado como RPS, &eacute; poss&iacute;vel baixar o arquivo ao lado e  utilizar como RPS da sua presta&ccedil;&atilde;o de servi&ccedil;os.<br />
          <br />
