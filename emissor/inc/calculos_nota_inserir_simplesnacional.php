...
<table width="100%" style="border:1px solid #FFFFFF" id="tblServicos" cellpadding="3">
	...
	<table width="100%">
		<tr align="center" bgcolor="#999999">
			<td width="33%" align="center"><b>Seleciona o Servição</b></td>
		...
		<fieldset><legend><b>ISS</b></legend>
			<table width="100%">
				  <tr>
					...
					<td width="69%" align="left"><input name="txtISS" type="text" size="10" class="texto" readonly="yes" style="text-align:right;" id="txtISS"></td>
			    </tr>	 
				  <tr>
					<td align="left"> 
					 Valor do ISS Retido    
