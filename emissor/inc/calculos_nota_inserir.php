            ...
            <div style="width:100%" id="retornoDivLinha">
                <table width="100%">
                    <tr align="center" bgcolor="#999999">
                        ...
                        <td width="15%" align="center"><b>Alíquota(%)</b></td>
                        <td width="13%" align="center"><b>ISS(R$)</b></td>
                        <td width="16%" align="center"><b>ISSRetido(R$)</b></td>
                        <td width="16%" align="center"><b>Cofins(R$)</b></td>
                    </tr>
                    <tr bgcolor="#FFFFFF" align="center">
                        <td>
                            <select name="cmbCodServico1" style="width:150px;" id="cmbCodServico1" 
                        ...
                        <td>
                            <input name="txtBaseCalcServico1" id="txtBaseCalcServico1" type="text" class="texto" size="11" onkeyup="MaskMoeda(this);" 
                        ...
                        <td><input name="txtValorIssServico1" id="txtValorIssServico1" type="text" class="texto" size="5" readonly="readonly" value="0,00" /></td>
                        <td>
                            <input name="txtISSRetidoManual1" id="txtISSRetidoManual1" type="text" class="texto" size="11" value="0,00" onblur="calculaISSNfe('hdInputs','1')" 
                                   onkeyup="MaskMoeda(this);" onkeydown="return NumbersOnly(event);" />
                        </td>
                        <td>
                            <input name="txtCofins1" id="txtCofins1" type="text" class="texto" size="8" value="0,00" onblur="calculaISSNfe('hdInputs','1')" 
                                   onkeyup="MaskMoeda(this);" onkeydown="return NumbersOnly(event);" />
                        </td>
                    </tr>
                </table>
...
<table width="100%">
    ...
    <tr>
        <td  align="left"><input name="btInserirNota" type="button"  value="Prosseguir" class="botao" onclick="javascript:confirmar();" ></td>
