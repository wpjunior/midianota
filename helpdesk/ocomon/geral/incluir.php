...
##################################################
		...
		if ((!empty($rowconf) && $rowconf['conf_scr_contact']) || empty($rowconf)) {
			...
			print "<TD width='30%' align='left' bgcolor=".BODY_COLOR."><INPUT type='text' class='text' name='contato' id='idContato' value='(99)9999-9999' ></TD>";//onChange=\"Habilitar();\"  onBlur=\"Habilitar();\"
		} else {
		...
		if ((!empty($rowconf) && $rowconf['conf_scr_fone']) || empty($rowconf)) {
			...
			if (isset($_POST['telefone'])) {
				$telefone = $_POST['telefone'];
	            	...
	            	print "<TD width='30%' align='left' bgcolor=".BODY_COLOR."><INPUT type='text' class='text2' name='telefone' id='idTelefone' value='9999' ></TD>";//onChange=\"Habilitar();\"
        	} else {
        		$telefone = null;
