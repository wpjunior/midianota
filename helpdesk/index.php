...
print "<title>Helpdesk Midiacom</title>";
...
if ($_SESSION['s_logado']){
	...
	print "<iframe class='frm_menu' src='menu.php?".$sis."".$PARAM."' name='menu' align='left' width='140px' height='100%' frameborder='0' STYLE='{border-right: thin solid #999999; border-bottom: thin solid #999999;}'></iframe>";
	print "</td>";
