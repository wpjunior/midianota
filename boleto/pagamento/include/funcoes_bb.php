...
if ($dadosboleto["formatacao_convenio"] == "6") {
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "1") {
		...
		$dv = modulo_11("$codigobanco$nummoeda$fator_vencimento$valor$nossonumero$agencia$conta$carteira");
		$linha = "$codigobanco$nummoeda$dv$fator_vencimento$valor$nossonumero$agencia$conta$carteira";
		//montando o nosso numero que aparecerá no boleto
		$nossonumero = $nossonumero ."-". modulo_11($nossonumero);
	}
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "2") {
		...
		$dv = modulo_11("$codigobanco$nummoeda$fator_vencimento$valor$nossonumero$nservico");
