...
<form name="frmInserir" method="post" action="notas.php?btPropria=T&btInserir=T" id="frmInserir" onsubmit="return ValidarInserirNota()">
...
<tr>
  ...
  <tr>
    ...
    <td align="left"><input name="txtTomadorIM" type="text" size="30" class="texto" onkeydown="return NumbersOnly( event );" ></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left">
	 <input name="txtTomadorCEP" type="text" size="15" class="texto" maxlength="9" onkeydown="return NumbersOnly( event );"  onkeyup="MaskCEP(this);" >
	</td>
  </tr>
  <tr>
