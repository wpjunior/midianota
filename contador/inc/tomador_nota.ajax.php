...
<tr>
  ...
  <tr>
    ...
    <td align="left"><input name="txtTomadorIM" onkeydown="return NumbersOnly( event );"  type="text" size="30" class="texto" value="<?php echo $dados->inscrmunicipal ;?>"<?php echo $disable; ?>></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left">
	 <input name="txtTomadorCEP" type="text" onkeydown="return NumbersOnly( event );"  size="15" class="texto" maxlength="9" value="<?php echo $dados->cep ;?>" onkeyup="MaskCEP(this);"<?php echo $disable; ?> >
	</td>
  </tr>
  <tr>
